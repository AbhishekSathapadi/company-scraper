...
class ExcelExportPipeline:
    def __init__(self):
        ...
        self.connection_string = "DefaultEndpointsProtocol=https;AccountName=acigcompanyscrapersa;AccountKey=WJ+P1LmKEjM3jAQjY9SiBrUj+FOpLgoqOmwdLtf7OnFOoE+UIou5jnwn1XrA/sCpLn5Q9Kg9Bq4n+AStth3pyQ==;EndpointSuffix=core.windows.net"
